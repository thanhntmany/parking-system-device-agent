...
class AppApi {
    ...
    start(port = 80) {
        ...
        app.get('/video', (req, res) => {
            ...
            const ffmpegArgs = [
                '-i', path.join(import.meta.dirname, "sample.mp4"), // Replace with your video path
            ...
            res.on('close', () => {
                ffmpegProcess.kill('SIGKILL'); // Terminate FFmpeg if client disconnects
            });
        ...
        // #TODO:
        // current latency is proximate 6 seconds
